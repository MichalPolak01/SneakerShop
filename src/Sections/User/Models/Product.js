...
const ShopList = [
  { 
      id: 1,
      products: [
          new Product(1, "Air Jordan 1", "Buty męskie", require('../../../../assets/Images/Login/Icon.png'), 499.99, 'Air Jordan 1 opis',sizes),
          new Product(2, "Inny produkt", "Kategoria", require('../../../../assets/Images/Login/Icon.png'), 99.99, 'Inny produkt opis',sizes),
          new Product(2, "Inny produkt", "Kategoria", require('../../../../assets/Images/Login/Icon.png'), 99.99, 'Inny produkt opis',sizes)  
      ]
  },
  { 
